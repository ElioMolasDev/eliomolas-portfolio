        ...
        {(onClose) => (
          <>
            ...
            <ModalBody className="justify-center p-4">
              ...
              <div className="text-lg font-semibold">
                <span className="text-[#99D52A]">Lenguajes de programación: </span>
              ...
              <div className="text-lg font-semibold">
                <span className="text-[#99D52A]">Herramientas de desarrollo: </span>
              ...
              <div className="text-lg font-semibold">
                <span className="text-[#99D52A]">Habilidades blandas: </span>
                {softSkills?.map((e, i) => (
                  <span className="text-sm my-auto" key={i}>
                    {e},{" "}
                  </span>
